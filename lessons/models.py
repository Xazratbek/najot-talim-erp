...
class LessonRating(TimeStampedModel):
    ...
    rated_by = models.ForeignKey(User,on_delete=models.CASCADE,related_name='reviews')
    star = models.IntegerField(validators=[MinValueValidator(1,message="Eng kam baxo 1 bo'lishi kerak"),MaxValueValidator(5,message="Eng ko'pi bilan naxo 5 bo'lishi mumkin")])
